...
#define P_LOG(severity)                   LOG_(PLOG_DEFAULT_INSTANCE, severity)
...
#define LOGV                            P_LOG_VERBOSE
#define LOGD                            P_LOG_DEBUG
#define LOGI                            P_LOG_INFO
#define LOGW                            P_LOG_WARNING
#define LOGE                            P_LOG_ERROR
#define LOGF                            P_LOG_FATAL
#define LOGN                            P_LOG_NONE
...
#define P_LOG_IF(severity, condition)             LOG_IF_(PLOG_DEFAULT_INSTANCE, severity, condition)

#define LOG_VERBOSE_IF(condition)               P_LOG_IF(plog::verbose, condition)
#define LOG_DEBUG_IF(condition)                 P_LOG_IF(plog::debug, condition)
#define LOG_INFO_IF(condition)                  P_LOG_IF(plog::info, condition)
#define LOG_WARNING_IF(condition)               P_LOG_IF(plog::warning, condition)
#define LOG_ERROR_IF(condition)                 P_LOG_IF(plog::error, condition)
#define LOG_FATAL_IF(condition)                 P_LOG_IF(plog::fatal, condition)
#define LOG_NONE_IF(condition)                  P_LOG_IF(plog::none, condition)
